(function () {
  ...
  const items = [
    ...
    {
      title: "CS-XZ8003C Curved Treadmill",
      code: "Cardio | Treadmills",
      category: "cardio",
      subcategory: "treadmills",
      series: "",
    ...
    {
      title: "LED Console Bike",
      code: "Cardio | Upright Bikes",
      category: "cardio",
    ...
    {
      title: "Squat Rack CS-XH021",
      code: "Strength | Racks + Stations",
      category: "strength",
    ...
    {
      title: "Functional Trainer CS-H005A",
      code: "Strength | Functional Training",
      category: "strength",
    ...
    {
      title: "Fusion Chest Press CS-K6-08",
      code: "Strength | Fusion Series",
      category: "strength",
    ...
    {
      title: "Fusion Shoulder Press CS-K6-06",
      code: "Strength | Fusion Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "fusion-series",
    ...
    {
      title: "Fusion Pec Fly & Rear Delt CS-K6-07",
      code: "Strength | Fusion Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "fusion-series",
    ...
    {
      title: "Fusion Lat Pull Down CS-K6-35",
      code: "Strength | Fusion Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "fusion-series",
    ...
    {
      title: "Fusion Leg Extension CS-K6-02",
      code: "Strength | Fusion Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "fusion-series",
    ...
    {
      title: "Flow Chest Press CS-M1-001",
      code: "Strength | Flow Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "flow-series",
    ...
    {
      title: "Flow Shoulder Press CS-M1-003",
      code: "Strength | Flow Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "flow-series",
    ...
    {
      title: "Flow Seated Row CS-M1-004",
      code: "Strength | Flow Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "flow-series",
    ...
    {
      title: "Flow Assisted Dip / Chin CS-M1-008",
      code: "Strength | Flow Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "flow-series",
    ...
    {
      title: "Flux Chest Press CS-TY01",
      code: "Strength | Flux Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "flux-series",
    ...
    {
      title: "Flux Shoulder Press CS-TY02",
      code: "Strength | Flux Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "flux-series",
    ...
    {
      title: "Flux Dip / Chin Assist CS-TY24",
      code: "Strength | Flux Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "flux-series",
    ...
    {
      title: "Fuel Chest Press CS-ASN001",
      code: "Strength | Fuel Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "fuel-series",
    ...
    {
      title: "Fuel Shoulder Press CS-ASN003",
      code: "Strength | Fuel Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "fuel-series",
    ...
    {
      title: "Fuel Seated Row CS-ASN004",
      code: "Strength | Fuel Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "fuel-series",
    ...
    {
      title: "Fuel Tricep Press CS-ASN007",
      code: "Strength | Fuel Series",
      category: "strength",
      subcategory: "selectorized-series",
      series: "fuel-series",
    ...
    {
      title: "Force Chest Press CS-MWH001",
      code: "Strength | Force Series",
      category: "strength",
    ...
    {
      title: "Force Incline Chest Press CS-MWH002",
      code: "Strength | Force Series",
      category: "strength",
      subcategory: "plate-loaded-series",
      series: "force-series",
    ...
    {
      title: "Force 45 Degree Leg Press CS-XH022",
      code: "Strength | Force Series",
      category: "strength",
      subcategory: "plate-loaded-series",
      series: "force-series",
  ...
  function renderCards() {
    ...
    filterButtons.forEach((button) => {
      const isActive =
        button.dataset.filterType === state.type &&
        (button.dataset.filterGroup || "") === state.group &&
        (button.dataset.filterValue || "") === state.value;
  ...
  filterButtons.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      state.group = button.dataset.filterGroup || "";
